...
public class PicturePoster extends JComponent {
    private Icon image = new ImageIcon(getClass().getResource("/view/icon/null.png"));
    private BufferedImage bufferedImage;
    
    public PicturePoster() {
        setOpaque(false);
        setPreferredSize(new Dimension(172, 278));
        setMaximumSize(new Dimension(172, 278));
        setMinimumSize(new Dimension(172, 278));
    }
   
    
    public PicturePoster(Icon image) {
        setOpaque(false);
