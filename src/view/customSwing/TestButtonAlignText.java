...
public class TestButtonAlignText extends JButton {
    ...
    public TestButtonAlignText() {
        ...
        setPaintedColor(new Color(58, 181, 75));
        setSizeSpeed(8f);
...
//        drawMultilineText(g);
    ...
    private void drawMultilineText(Graphics g) {
        ...
        if (text != null && !text.isEmpty()) {
            ...
            int y = (getHeight() - totalTextHeight) / 2 + g2d.getFontMetrics().getAscent();
